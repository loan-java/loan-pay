...
public final class HttpUtils {
	...
	public final static String TAOBAO_LOCATION_API = "http://ip.taobao.com/service/getIpInfo.php";
	public final static String BAIDU_LOCATION_API = "http://api.map.baidu.com/location/ip";
	public final static String BAIDU_KEY = "ak";
	public final static String BAIDU_VALUE = "SOb3pD3FNnx9c2QgPeXNfMrTBkN6Wi54";
	...
	public static String loaction(String ip) {
		Map<String, String> parameters = new HashMap<String, String>();
		// parameters.put(BAIDU_KEY,BAIDU_VALUE );
		parameters.put("ip", ip);
		return HttpUtils.doPost(TAOBAO_LOCATION_API, parameters);
	}

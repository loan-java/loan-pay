...
public class RabbitConst {
	...
	public final static String queue_order_pay = "queue_order_pay"; // 放款队列
	public final static String queue_order_pay_query = "queue_order_pay_query"; // 放款结果查询

	public final static String queue_order_pay_query_wait = "queue_order_pay_query_wait"; // 放款结果查询等待9s
	public final static String queue_order_pay_query_wait_long = "queue_order_pay_query_wait_long"; // 放款结果查询等待600s
